...
- PR #27 and PR #28 provide domain evidence only; FR-002 remains planned until typed Electron integration, complete import journeys, restart persistence, and Electron E2E are implemented in PR #29.
